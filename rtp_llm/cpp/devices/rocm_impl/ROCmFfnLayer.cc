...
MoeDispatchOutput ROCmDevice::epDispatch(const MoeDispatchParams& params) {
    ...
    // sync clone to make sure experts_ids_host got correct data
    BufferPtr experts_ids_host = clone({*expert_ids, AllocationType::HOST, BufferHints(), params.overlapped, false});
