...
void AiterWrapper::mtp(const AttentionModuleParams& params, rtp_llm::DeviceBase* device, Buffer& q_mtp) {
    ...
    // TODO  : enable AiterWrapper::mtp in decode stage
    // Decode: max_seq_len = params.common.decoder_max_seq_len + 1;
    int64_t max_seq_len = params.common.context_max_seq_len +  params.common.max_prefix_length;
    ...
    // Decode: max_seq_len = sequence_lengths + 1;
