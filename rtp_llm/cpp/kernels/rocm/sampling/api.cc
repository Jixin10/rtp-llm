...
// void softmax(torch::Tensor workspace_buffer, torch::Tensor logits, torch::Tensor output,
//              std::optional<torch::Tensor> maybe_temperature_arr, double temperature_val, bool enable_pdl) {
...
// void sampling_from_logits(torch::Tensor logits, torch::Tensor output, std::optional<torch::Tensor> maybe_indices,
...
// void sampling_from_probs(torch::Tensor probs, torch::Tensor output, std::optional<torch::Tensor> maybe_indices,
//                          bool deterministic, uint64_t philox_seed, uint64_t philox_offset) {
//   CHECK_INPUT(probs);
...
//   auto stream = get_stream(probs->device);
  std::cout << "top_p_sampling_from_probs preparing kernel" << std::endl;
...
// void min_p_sampling_from_probs(torch::Tensor probs, torch::Tensor output,
//                                std::optional<torch::Tensor> maybe_indices,
...
// void chain_speculative_sampling(torch::Tensor draft_probs, torch::Tensor draft_token_ids,
//                                 torch::Tensor target_probs, torch::Tensor output_token_ids,
//                                 torch::Tensor output_accepted_token_num,
//                                 torch::Tensor output_emitted_draft_token_num, bool deterministic,
